...
#+begin_src shell :session renice1 :async yes :exports both
vi &
#+end_src
...
#+RESULTS:
| 6200 (process ID) old priority 0 | new priority 10 |
...
Por lo tanto, si se desea decrementar de =10= la amabilidad del proceso =1234=, en lugar de fijarlo en el valor =-10=, se puede utilizar el comando:

#+begin_src shell :exports both
renice --relative 1 6200
renice --relative 1 6200
#+end_src

#+RESULTS:
| 6200 (process ID) old priority 10 | new priority 14 |
| 6200 (process ID) old priority 12 | new priority 18 |
